...
**Para conectar o GenStudio for Performance Marketing com suas contas Meta**:

1. Em _Configurações_, clique em **[!UICONTROL Conectar]** no bloco Metadados. A exibição da _Conta de metadados_ é aberta.

1. Selecione **[!UICONTROL Permitir pop-ups]** do seu navegador, se solicitado.

1. Selecione uma ou mais de suas contas publicitárias para se conectar e clique em **[!UICONTROL Selecionar]**.
