...
Para criar um anúncio de carrossel de várias placas em vez de uma única imagem ou anúncio de vídeo, consulte [Criar uma experiência de anúncio de carrossel do Meta](/help/user-guide/create/create-meta-carousel-ad.md).
