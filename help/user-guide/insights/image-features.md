...
| Ângulo da câmera | A perspectiva a partir da qual a câmera captura o assunto, que afeta a percepção e interpretação da imagem pelo espectador. Se o estilo da Imagem for `photograph`, essa característica será identificada. | `Low angle`, `High angle`, `Eye level`, `Neutral angle`, `Bird's eye view`<p>Exemplo de `eye level`:<p>![nível dos olhos](/help/assets/category/image-camera-angle.png "Pessoas sentadas em ângulos diferentes"){width="200" zoomable="yes"} |
