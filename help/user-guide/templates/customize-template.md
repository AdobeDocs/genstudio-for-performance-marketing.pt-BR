...
Cada seção pode usar apenas um de cada tipo de campo.Por causa dessa regra, as seções não podem ser aninhadas.

Por exemplo, os seguintes campos pertencem à seção `pod1`:
