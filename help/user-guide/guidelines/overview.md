---
title: Visão geral das Diretrizes de Canal
description: Adicione diretrizes de canal à GenStudio for Performance Marketing para criar um perfil de marca abrangente que inclua todos os aspectos da representação de uma marca.
level: Beginner
...
>[!VIDEO](https://video.tv.adobe.com/v/3502935?captions=por_br&learn=on)

As diretrizes do GenStudio for Performance Marketing podem ser carregadas ou adicionadas manualmente ao GenStudio for Performance Marketing, permitindo que os usuários estabeleçam diretrizes de marca que capturam a essência da identidade de uma marca.
...
* Diretrizes definidas pelo usuário (como [!DNL Brands], [!DNL Products] e [!DNL Personas])
* Diretrizes de plataforma para canais como Meta, LinkedIn e muito mais
...
Consulte [Adicionar diretrizes](/help/user-guide/guidelines/add-guidelines.md) para saber como adicionar cada tipo.
...
As Diretrizes do canal permitem dois casos de uso principais para garantir que qualquer conteúdo gerado siga a representação desejada de uma marca:
...
Juntamente com a funcionalidade de IA gerativa do Adobe, o [!DNL Brands], o [!DNL Products] e o [!DNL Personas] desempenham um papel crucial para garantir que todo o conteúdo do GenStudio for Performance Marketing esteja alinhado à identidade da sua marca.
...
* **Conformidade com a plataforma**: essencial para seguir as diretrizes específicas de cada plataforma, como o Meta ou o LinkedIn, e seguir as práticas recomendadas do setor. Estas são as diretrizes padrão presentes no sistema e pré-preenchidas em [[!DNL Brand] diretrizes](/help/user-guide/guidelines/brands.md#brands-guidelines).
