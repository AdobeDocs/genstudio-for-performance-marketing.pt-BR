...
+ Assistentes de IA
  ...
  + [Referência das ferramentas do assistente de IA](ai-assistants/tools-reference.md)
...
+ Criar {#create}
  ...
  + [Anúncios de TV conectados](create/create-ctv.md)
  ...
  + [Criar experiência de anúncio do Meta - Anúncios do carrossel](create/create-meta-carousel-ad.md)
  + [Criar uma experiência de anúncio de ChatGPT](create/create-chatgpt-ad.md)
...
+ Modelos {#templates}
  + [Trabalhar com modelos](templates/use-templates.md)
  + [Modelos iniciais](templates/starter-templates.md)
  + [Personalizar um modelo](templates/customize-template.md)
  + [Editor de código de modelo](templates/code-editor.md)
  + [Criar modelos acessíveis](templates/accessibility-for-templates.md)
  + [Usando modelos Expressos](/help/user-guide/templates/express-templates.md)
  + [Práticas recomendadas para modelos](templates/best-practices-for-templates.md)
...
+ Ativar {#activation}
  ...
  + Anúncios de mídia paga {#paid-media-ads}
    ...
    + [GPTchat](activation/activate-chatgpt-ad.md)
    + [Trade Desk](activation/activate-trade-desk-ad.md)
+ Insights {#insights}
  + [Visão geral dos insights](insights/overview.md)
  + [Filtros do Insights](insights/filter-views.md)
  + [Campanhas](insights/campaigns.md)
  + [Detalhes das experiências publicadas](insights/published-experiences.md)
