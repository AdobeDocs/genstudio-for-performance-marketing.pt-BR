...
A exibição [!DNL Insights] _[!UICONTROL Campanhas]_ mostra uma lista de campanhas para a conta de anúncio do canal conectado.

{{connect-insights}}

A tabela _[!UICONTROL Campanhas]_ é organizada usando a campanha publicitária baseada em canal. Clique no ícone de configurações (cog) acima do lado direito da tabela para alternar as colunas visualizáveis.

![Filtro de campanhas e tabela](/help/assets/insights-campaigns-filter.png){zoomable="yes"}

Quando você seleciona uma campanha, a [[!UICONTROL guia Anúncios]](published-experiences.md) abre uma lista de nomes de anúncios associados a essa campanha, o que permite identificar quais anúncios contribuíram para seu sucesso geral.
